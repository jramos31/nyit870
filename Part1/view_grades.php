												...
												<div class="row">
													<div class="col-lg-12">
														<div class="alert alert-warning">
															<p align="center">There are no courses listed for you.</p>
														</div>
													</div>
												</div>';
											exit();
										...
										if (!(mysqli_num_rows($r)>0)) { // No results
												echo '
													<div class="row">
														<div class="col-lg-12">
															<div class="alert alert-warning">
																<p align="center">You don\'t have grades listed for:<br>' . $cname . '.</p>
															</div>
														</div>
													</div>';
										} else {
										...
										if (!(mysqli_num_rows($r)>0)) { // No results
											echo '
												<div class="row">
													<div class="col-lg-12">
														<div class="alert alert-warning">
															<p align="center">There are no hw assignments listed for this student.</p>
														</div>
													</div>
												</div>';
										} else {
