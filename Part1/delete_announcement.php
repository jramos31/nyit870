        			...
        			if ($_POST['sure'] == 'Yes') {
        				...
        				if (mysqli_affected_rows($dbc) == 1) {  // DELETE query was successful
                                ...
                                <div class="row">
        						    <div class="col-lg-12">
        							    <div class="alert alert-success">
                                            <p align="center">Posted announcement has been deleted!</p>
                                        </div>
        						    </div>
        					    </div>';
        					...
        					echo '
                                <div class="row">
        						    <div class="col-lg-12">
        						        <div class="alert alert-warning">
                                            <p align="center">This announcement could not be deleted due to system error.</p>
                                        </div>
        						    </div>
        					    </div>';
        				...
        				echo '
                            <div class="row">
        					    <div class="col-lg-12">
        					        <div class="alert alert-warning">
                                        <p align="center">The announcement has not been deleted.</p>
                                    </div>
        					    </div>
        				    </div>';
        			}
        			...
        			if (mysqli_num_rows($r) == 1) {  // user_id is valid, show the form
        				...
        				echo '
                            <div class="row">
            					<div class="col-lg-12">
            						<div class="alert alert-warning">
                                        <h3 align="left">Subject: ' . $row[0] . '</h3><h3 align="left">Content: ' . $row[1] . '</h3>
                            ...
                            <div class="col-md-3 col-md-offset-4">
        						<div class="panel panel-default">
        							<div class="panel-heading">
        								<h3 class="panel-title">Are you sure you want to delete this announcement?</h3>
                                    </div>
